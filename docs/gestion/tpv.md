...
La administración educativa nos brinda un sistema de pagos por TPV que es operativo, funciona, pero que permite unas posibilidades muy básicas que hemos superado con IesApp.

El funcionamiento es el siguiente:

- Cualquier profesor puede registrar "servicios" que pueden pagarse por TPV. El servicio estará visible para realizar pagos tras el visto bueno del secretario, no antes.
